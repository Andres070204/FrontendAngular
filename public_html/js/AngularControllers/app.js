...
aplicacionMundial.controller("competitorCtrl", function ($http, $scope) {
    $scope.addCompetitor = function () {
        console.log('Añadiendo competidor:', $scope.competitor);
        $http.post('http://localhost:8080/competitors/add', $scope.competitor)
            .then(function (response) {
                $scope.competitor = {}; 
                $scope.toolbar.selectTab(2); 
                console.log('Competidor añadido con éxito:', response.data);
            })
